...
function getGooglePaymentsClient() {
    console.log(`paymentsClientDotNetRef is ${paymentsClientDotNetRef}`);
...
function createButton(paymentsClient, onGooglePaymentButtonClicked, buttonType) {
...
async function isReadyToPay(paymentsClient) {
    let response = null;
    try {
 ...
 */
function prefetchGooglePaymentData(paymentsClient) {
